...
function extractNameFromTemplate(value) {
  ...
  return splitted[1].slice(0, splitted[1].length - 1);
}
...
function removeFirstOccurrences(str, value) {
  const newStr = str.slice(0, str.indexOf(value)) + str.slice(str.indexOf(value) + value.length);
  return newStr;
}
